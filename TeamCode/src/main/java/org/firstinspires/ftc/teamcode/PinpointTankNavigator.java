...
public class PinpointTankNavigator extends OpMode {
    ...
    private static final double TURN_KD = 0.0015;
    private static final double DRIVE_KP = 0.018;
    private static final double SLOW_DISTANCE_CM = 20;
    private static final double POSITION_TOLERANCE_CM = 1;
    ...
    public void loop() {
        ...
        if (distance < SLOW_DISTANCE_CM) {
            drivePower *= Math.max(0.25, distance / SLOW_DISTANCE_CM);
        }

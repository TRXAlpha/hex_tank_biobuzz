 ...
 */
@Autonomous(name = "Patrat 600mm", group = "Auto")
public class gtpPatratRotund extends LinearOpMode {
    ...
    static final double SIDE_MM = 600.0;
    ...
    // ----- Tolerante oprire -----
    static final double DISTANCE_TOLERANCE_MM = 15.0;
    ...
    static final double CORNER_RADIUS_MM = 120.0;
     ...
     * @param fullStopWhenReached daca true, motoarele sunt oprite complet la sfarsit
    ...
    private void goToPoint(double targetX, double targetY, double toleranceMm, boolean fullStopWhenReached) {
        ...
        while (opModeIsActive()) {
            ...
            if (distanceToTarget <= toleranceMm) {
                break; // punct atins
            }
